   ...
   <div id="main">
        <div id="main-inner">
            ...
            include "includes/menu.php";
                    ...
                    echo "<h2 align='center'>Casas com vagas Disponiveis</h2>";
                ?>
            ...
            <div class='box'>
                <h4><?=strtoupper(normalizarString($casa['cs_endereco']." -- ".$casa['us_nome']))?></h4>
            ...
            <table border="1" class="table-striped table-bordered">
                ...
                ?>
                   ...
                   ?> <p><input type='button' value='Voltar' class='btn btn-info' style='margin:auto' onclick='javascript: window.location.href="index.php"'></p>
            </div> <?php
                } 
                else{
